    ...
    /* 
        defaultMenu: IMenuItem[] = [
            ...
            },
            {
                ...
                icon: 'i-Library',
                sub: [
                    { icon: 'i-Bell1', name: 'Alerts', state: '/uikits/alerts', type: 'link' },
                    ...
                    { icon: 'i-Mustache', name: 'Cards widget', state: '/uikits/cards-widget', type: 'link' },
                    ...
                    { icon: 'i-Speach-Bubble-2', name: 'Popover', state: '/uikits/popover', type: 'link' },
            ...
            },
            {
                ...
                sub: [
                    ...
                    { icon: 'i-Face-Style-6', name: 'Input Mask', state: '/forms/input-mask', type: 'link' },
    ...
    defaultMenu: IMenuItem[] = [
        {
            ...
            icon: 'i-Bar-Chart',
            sub: [
                { icon: 'i-Jeep', name: 'SCM', state: '/home', type: 'link' },
                { icon: 'i-Shop-2', name: 'CRM', state: '/index-map', type: 'link' },
                { icon: 'i-Shop-4', name: 'Pending Call', state: '/branch-map', type: 'link' }
            ]
        }
    ];
